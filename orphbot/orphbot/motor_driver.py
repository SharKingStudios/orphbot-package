...
class MotorDriver(Node):
    def __init__(self):
        ...
        self.declare_parameter('left_front_pins', [6, 13])
        self.declare_parameter('left_rear_pins', [19, 26])
        self.declare_parameter('right_front_pins', [12, 16])
        self.declare_parameter('right_rear_pins', [20, 21])
